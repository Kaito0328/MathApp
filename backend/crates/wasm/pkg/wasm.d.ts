...
export interface InitOutput {
  ...
  readonly dft_real: (a: number, b: number) => [number, number];
  readonly ift_real: (a: number, b: number, c: number) => [number, number];
  readonly conv_real: (a: number, b: number, c: number, d: number) => [number, number];
  readonly init: () => void;
