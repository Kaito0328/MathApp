...
export const __wbg_sourcearithmetic_free: (a: number, b: number) => void;
export const sourcearithmetic_new: (a: number, b: number, c: number, d: number) => [number, number, number];
export const sourcearithmetic_encode: (a: number, b: number, c: number) => [number, number, number, number];
export const sourcearithmetic_decode: (a: number, b: number, c: number, d: number) => [number, number, number, number];
export const __wbg_sourcehuffman_free: (a: number, b: number) => void;
export const sourcehuffman_new: (a: number, b: number, c: number, d: number) => [number, number, number];
export const sourcehuffman_encode: (a: number, b: number, c: number) => [number, number];
export const sourcehuffman_decode: (a: number, b: number, c: number, d: number) => [number, number];
export const __wbg_eliasgamma_free: (a: number, b: number) => void;
export const eliasgamma_encode: (a: bigint) => [number, number];
export const eliasgamma_decode: (a: number, b: number, c: number) => any;
export const __wbg_craftcode_free: (a: number, b: number) => void;
export const craftcode_build: (a: number, b: number, c: number) => any;
export const __wbg_jones_free: (a: number, b: number) => void;
export const jones_new: (a: number, b: number, c: number, d: number, e: number) => [number, number, number];
export const jones_encode: (a: number, b: number, c: number) => [number, number];
export const jones_decode: (a: number, b: number, c: number, d: number) => [number, number];
export const __wbg_lz78_free: (a: number, b: number) => void;
export const lz78_new: () => number;
export const lz78_encodeInternal: (a: number, b: number, c: number) => any;
export const lz78_decodeInternal: (a: number, b: any) => [number, number];
export const __wbg_markov_free: (a: number, b: number) => void;
export const markov_new: (a: number, b: number, c: number, d: number, e: any) => number;
export const markov_blockPr: (a: number, b: number, c: number) => number;
export const __wbg_blockhuffman_free: (a: number, b: number) => void;
export const blockhuffman_new: (a: number, b: any, c: number, d: number) => number;
export const blockhuffman_encode: (a: number, b: any) => [number, number];
export const blockhuffman_decode: (a: number, b: number, c: number, d: number) => any;
...
export const hamming74_new: () => number;
export const hamming74_encode: (a: number, b: number, c: number) => [number, number, number, number];
export const hamming74_parityCheck: (a: number) => [number, number, number, number];
export const hamming74_decode: (a: number, b: number, c: number) => [number, number, number, number];
...
export const linearcode_parityCheck: (a: number) => [number, number, number, number];
export const linearcode_decodeSyndrome: (a: number, b: number, c: number, d: number) => [number, number, number, number];
export const linearcode_decodeWithH: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number, number];
...
export const cycliccode_decodeWithH: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number, number];
export const cycliccode_decodeLUT: (a: number, b: number, c: number) => [number, number, number, number];
export const __wbg_reedsolomon_free: (a: number, b: number) => void;
export const reedsolomon_new: (a: number, b: number) => [number, number, number];
...
export const reedsolomon_decodeBM: (a: number, b: number, c: number) => [number, number, number, number];
export const __wbg_bch_free: (a: number, b: number) => void;
export const bch_new: (a: number, b: number, c: number) => number;
export const bch_newAuto: (a: number, b: number) => number;
...
export const bch_decodeWithH: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number, number];
export const bch_decodeLUT: (a: number, b: number, c: number) => [number, number, number, number];
export const bch_decodeBM: (a: number, b: number, c: number) => [number, number, number, number];
...
export const parityCheckFromGeneratorGF2: (a: number, b: number, c: number, d: number) => [number, number, number, number];
export const computeSyndromeGF2: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number, number];
export const syndromeDecodeGF2: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number, number];
export const boundedDistanceDecodeGF2: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number, number, number];
export const hammingDMinGF2: (a: number, b: number, c: number) => [number, number, number];
export const codingRateFromGeneratorGF2: (a: number, b: number, c: number, d: number) => [number, number, number];
...
export const matrixf64_rref: (a: number) => [number, number, number];
export const matrixf64_rrefWith: (a: number, b: number) => [number, number, number];
export const matrixf64_lu: (a: number) => [number, number, number];
...
export const matrixf32_rref: (a: number) => [number, number, number];
export const matrixf32_rrefWith: (a: number, b: number) => [number, number, number];
export const matrixf32_lu: (a: number) => [number, number, number];
