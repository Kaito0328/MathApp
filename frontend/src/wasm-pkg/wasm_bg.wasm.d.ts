...
export const wasmdiscretetf_new: (a: number, b: number, c: number, d: number, e: number) => number;
export const wasmdiscretetf_sample_rate: (a: number) => number;
export const wasmdiscretetf_set_sample_rate: (a: number, b: number) => void;
export const wasmdiscretetf_b_coeffs: (a: number) => [number, number];
export const wasmdiscretetf_a_coeffs: (a: number) => [number, number];
export const wasmdiscretetf_is_stable: (a: number) => number;
export const wasmdiscretetf_impulse_response: (a: number, b: number) => [number, number];
export const wasmdiscretetf_step_response: (a: number, b: number) => [number, number];
export const wasmdiscretetf_frequency_response_mag_phase: (a: number, b: number) => [number, number];
export const wasmdiscretetf_bode_svg: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number];
export const wasmdiscretetf_nyquist_svg: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number];
export const wasmdiscretetf_series: (a: number, b: number) => number;
export const wasmdiscretetf_parallel: (a: number, b: number) => number;
export const wasmdiscretetf_feedback_unity: (a: number) => number;
export const wasmdiscretetf_block_feedback_svg: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number];
export const __wbg_continuoustf_free: (a: number, b: number) => void;
export const wasmcontinuoustf_new: (a: number, b: number, c: number, d: number) => number;
export const wasmcontinuoustf_b_coeffs: (a: number) => [number, number];
export const wasmcontinuoustf_a_coeffs: (a: number) => [number, number];
export const wasmcontinuoustf_is_stable: (a: number) => number;
export const wasmcontinuoustf_impulse_response: (a: number, b: number, c: number) => [number, number];
export const wasmcontinuoustf_step_response: (a: number, b: number, c: number) => [number, number];
export const wasmcontinuoustf_frequency_response_mag_phase: (a: number, b: number, c: number) => [number, number];
export const wasmcontinuoustf_to_discrete_bilinear: (a: number, b: number) => number;
export const wasmcontinuoustf_to_discrete_bilinear_prewarp: (a: number, b: number, c: number) => number;
export const wasmcontinuoustf_bode_svg: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => [number, number];
export const wasmcontinuoustf_nyquist_svg: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number];
export const wasmcontinuoustf_block_feedback_svg: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number];
export const __wbg_continuouszpk_free: (a: number, b: number) => void;
export const wasmcontinuouszpk_new: (a: number, b: number, c: number, d: number, e: number) => number;
export const wasmcontinuouszpk_from_tf: (a: number) => number;
export const wasmcontinuouszpk_to_tf: (a: number) => number;
export const wasmcontinuouszpk_zeros_interleaved: (a: number) => [number, number];
export const wasmcontinuouszpk_poles_interleaved: (a: number) => [number, number];
export const wasmcontinuouszpk_gain: (a: number) => number;
export const __wbg_discretezpk_free: (a: number, b: number) => void;
export const wasmdiscretezpk_new: (a: number, b: number, c: number, d: number, e: number, f: number) => number;
export const wasmdiscretezpk_from_tf: (a: number) => number;
export const wasmdiscretezpk_to_tf: (a: number) => number;
export const wasmdiscretezpk_zeros_interleaved: (a: number) => [number, number];
export const wasmdiscretezpk_poles_interleaved: (a: number) => [number, number];
export const wasmdiscretezpk_sample_rate: (a: number) => number;
export const __wbg_continuousss_free: (a: number, b: number) => void;
export const wasmcontinuousss_new: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number) => number;
export const wasmcontinuousss_from_tf_siso: (a: number, b: number, c: number, d: number) => number;
export const wasmcontinuousss_to_tf_siso: (a: number) => [number, number];
export const wasmcontinuousss_c2d_zoh: (a: number, b: number) => number;
export const wasmcontinuousss_a_flat: (a: number) => [number, number];
export const wasmcontinuousss_b_flat: (a: number) => [number, number];
export const wasmcontinuousss_c_flat: (a: number) => [number, number];
export const wasmcontinuousss_d_flat: (a: number) => [number, number];
export const wasmcontinuousss_a_shape: (a: number) => [number, number];
export const wasmcontinuousss_b_shape: (a: number) => [number, number];
export const wasmcontinuousss_c_shape: (a: number) => [number, number];
export const wasmcontinuousss_d_shape: (a: number) => [number, number];
export const __wbg_discretess_free: (a: number, b: number) => void;
export const wasmdiscretess_to_tf_siso: (a: number) => [number, number];
export const wasmdiscretess_a_flat: (a: number) => [number, number];
export const wasmdiscretess_b_flat: (a: number) => [number, number];
export const wasmdiscretess_c_flat: (a: number) => [number, number];
export const wasmdiscretess_d_flat: (a: number) => [number, number];
export const wasmdiscretess_a_shape: (a: number) => [number, number];
export const wasmdiscretess_b_shape: (a: number) => [number, number];
export const wasmdiscretess_c_shape: (a: number) => [number, number];
export const wasmdiscretess_d_shape: (a: number) => [number, number];
export const wasmdiscretezpk_gain: (a: number) => number;
export const wasmdiscretess_new: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number) => number;
